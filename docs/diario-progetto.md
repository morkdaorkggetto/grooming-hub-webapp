...
**Sequenza verso il 1/9**: GH-08 → GH-09 → GH-10 → GH-11 → atto G6 (27-28/8, salone chiuso) → merge + deploy prod → margine 29-31 → rientro Davide e Roby sul sistema nuovo. Unico dettaglio esterno residuo, non bloccante: se l'orario continuato 9–19 vale identico tutti i giorni o qualche giorno cambia (riga WhatsApp leggera a Davide, utile per il copy delle chip ma non per la struttura).
...
**Prossimo passo**: push Luigi (3 commit: `0834c8c` codice + `bdecf94` registri GH-08 + il mio commit documentale di stanotte con diario, README aggiornato, ERRATA, mandati GH-08..GH-11). Poi GH-09 a Codex.
