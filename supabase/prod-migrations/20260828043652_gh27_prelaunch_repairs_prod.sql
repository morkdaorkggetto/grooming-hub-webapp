-- GH-30 variante prod-safe di GH-27.
-- Fonte: docs/incarichi/GH-27-riparazioni-pre-lancio.md e
-- docs/incarichi/GH-30-ricetta-g6-ripresa.md.
-- Orari nel fuso del tenant, QR pet, risposta staff alle richieste e chiusura
-- atomica di visita + appuntamento.
